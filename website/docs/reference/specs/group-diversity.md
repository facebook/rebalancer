...
- Thrift definition: [`interface/thrift/ProblemSpecs.thrift`](https://github.com/facebook/rebalancer/blob/main/algopt/rebalancer/interface/thrift/ProblemSpecs.thrift) (`GroupDiversitySpec`, `GroupDiversityBound`)
- SpecBuilder: [`materializer/spec_builder/GroupDiversitySpecBuilder.cpp`](https://github.com/facebook/rebalancer/blob/main/algopt/rebalancer/materializer/spec_builder/GroupDiversitySpecBuilder.cpp)---the code that defines this spec's behavior
- Tests and runnable examples: [`interface/tests/GroupDiversityTest.cpp`](https://github.com/facebook/rebalancer/blob/main/algopt/rebalancer/interface/tests/GroupDiversityTest.cpp)---the unit tests the snippets on this page are drawn from
