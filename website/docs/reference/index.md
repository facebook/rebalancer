...
| GroupCount | Both | Limit how many objects of a group a scope item holds, or their total for a dimension | [unit tests](https://github.com/facebookincubator/rebalancer/blob/main/algopt/rebalancer/interface/tests/GroupCountTest.cpp) |
